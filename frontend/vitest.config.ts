      ...
      projects: [
        {
          ...
          test: {
            ...
            exclude: [
              ...
              // real backend lands or if MSW is adopted.
              "src/data/api.test.ts",
              "src/data/application-lifecycle.test.ts",
              "src/data/deep-match-score.test.ts",
              "src/data/interview-rounds.test.ts",
              "src/data/library-trash.test.ts",
              "src/data/resume-scoring-export.test.ts",
              "src/data/resume-snapshot.test.ts",
              "src/hooks/use-agent-log.test.tsx",
              "src/hooks/use-agent.test.tsx",
              "src/hooks/use-agents.test.tsx",
              "src/hooks/use-application.test.tsx",
              "src/hooks/use-applications.test.tsx",
              "src/hooks/use-coach-thread.test.tsx",
              "src/hooks/use-coach-threads.test.tsx",
              "src/hooks/use-current-user.test.tsx",
              "src/hooks/use-jobs-inbox.test.tsx",
              "src/hooks/use-match-report.test.tsx",
              "src/hooks/use-notifications.test.tsx",
              "src/hooks/use-resume.test.tsx",
              "src/hooks/use-resumes.test.tsx",
              "src/hooks/use-search.test.tsx",
              "src/hooks/use-searches.test.tsx",
              "src/hooks/use-settings.test.tsx",
              "src/hooks/use-shortlist.test.tsx",
              "src/hooks/use-user-menu.test.tsx",
              "src/components/domain/notifications-popover.test.tsx",
              "src/components/domain/user-menu-popover.test.tsx",
              "src/components/shell/sidebar.test.tsx",
              "src/screens/agent-detail/agent-detail.test.tsx",
              "src/screens/agents/agents.test.tsx",
              "src/screens/app-detail/app-detail.test.tsx",
              "src/screens/applications/applications.test.tsx",
              "src/screens/coach/coach.test.tsx",
              "src/screens/library/trash/trash.test.tsx",
              "src/screens/match-explorer/match-explorer.test.tsx",
              "src/screens/resume-editor/resume-editor.test.tsx",
              "src/screens/resume-preview/resume-preview.test.tsx",
              "src/screens/resumes/resumes.test.tsx",
              "src/screens/search-criteria/search-criteria.test.tsx",
              "src/screens/search-detail/search-detail.test.tsx",
