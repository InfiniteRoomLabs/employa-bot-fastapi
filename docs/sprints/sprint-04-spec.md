...
- 3b: the mutation function + transitionApplication + getResumeSnapshot + APPLIED snapshot/lock + AC-04a/b/c + AC-05 + two-connection tests + PIN-11 teardown helper. Commit boundary (gated).
